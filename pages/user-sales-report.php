...
<?php 
      if(isset($_GET['action'])){ 
        ...
        ?>
        <script>
          window.location.href = 'user-sales-report.php';
        </script>
        <?php
      }
    ?>
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="user-sales-report.php" class="active">
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <p align="center">Dispense Data</p><br>
          <hr>
                ...
                <div class="col-md-5">  
                     ...
                     <a href="user-sales-report.php?action=refresh" class="btn btn-primary" >Refresh</a> 
                </div>  
