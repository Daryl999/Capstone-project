  ...
  <section class="home-section">
    ...
    <div class="home-content">
      ...
      <ul class="nav navbar-nav" style="background-color: #d2f4e8; width: 100%; margin-bottom: 2%; border-radius: 0.25rem">
        <li><a href="admin-patient-record.php">Patient Record</a></li>
        <li class="active"><a href="admin-archive-patient-record.php">Archived Record</a></li>
      </ul><br>
    
          <?php 
          include 'connection.php';
            $query = "SELECT * FROM `archivepatientprofiletbl`";
 ...
 -->
            <table id="myTable" class="table table-striped table-bordered table-hover">  
              ...
              <tbody style="font-size: 15px;">  
                  ...
                  <div class="column">
                    <tr align="center">
                      <td><?php echo $row['archive_cnum'];?></td>
                      <td><?php echo $row['archive_lname'];?></td>
                      <td><?php echo $row['archive_fname'];?></td>
                      <td><?php echo $row['archive_mname'];?></td>
                      <td><?php echo $row['archive_gend'];?></td>
                      <td><?php echo $row['archive_wrd'];?></td>
                      <td><?php echo date("M d,Y",strtotime($row['archive_dadmit'])) ?></td>
                      <td>
                        <a href="admin-archive-patient-record-action.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to restore this record?');" class="btn btn-info">Restore</a>
                        <a href="admin-archive-patient-record.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this record?');" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  </div>
                  <?php
...
if(isset($_GET['id'])){
  $id=$_GET['id'];
  $result=$con->query("DELETE from archivepatientprofiletbl WHERE id='$id'");
