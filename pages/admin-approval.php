...
<body>
  ...
  <section class="home-section">
    ...
    $query = "SELECT * FROM approvaltbl WHERE account_status='Verified' OR account_status='Not Verified' ";
    ...
    <div class="home-content">
      ...
      <ul class="nav navbar-nav" style="background-color: #d2f4e8; width: 100%; margin-bottom: 2%; border-radius: 0.25rem">
        <li class="active"><a href="admin-approval.php">Approval</a></li>
        <li><a href="admin-archive-approval.php">Archived</a></li>
      </ul><br>
            ...
            <?php
             while ($row = mysqli_fetch_array($result)) {
              ...
              <tr>
                ...
                <td>
                  <a href="admin-user-profile.php?id=<?php echo $row['id']; ?>&approved_email_address=<?php echo $row['approved_email_address']; ?>" class="btn btn-info">View</a>
                  <!-- <a href="admin-approval-action.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this record?');" class="btn btn-danger">Delete</a> -->
                </td>
              </tr>
            <?php } ?>
            </tbody>
