...
<div class="column">
  ...
  <br>
  <div class="column">
  <form action="user-details-edit-action.php?id=<?php echo $row['id'];?>" method="POST">
  <div class="details"><br>
    <h3><b>DETAILS</b>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="user-patient-dataview.php?patient_id=<?php echo $row['id'];?>"><i class="fa fa-arrow-circle-left"></i></a></h3>
    <br>
    <h5>BIRTHDAY</h5>
