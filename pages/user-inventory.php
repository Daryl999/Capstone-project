  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="user-inventory.php" class="active">
...
if (isset($_POST['search'])) {
  ...
  if (empty($valuesearchcategory)) {
    ...
    echo "<script>document.location='user-inventory.php';</script>";
...
<form action="user-inventory.php" method="post">
  <div class="col-md-6">
  ...
  <div class="col-md-6">
        ...
        <!-- <a href="user-category.php"  class="btn btn-success" >Add Category</a> -->
        <!-- <a href="user-add-medicine.php"  class="btn btn-success" >Add Medicine</a> -->
        <a href="user-inventory.php?action=refresh" class="btn btn-primary" >Refresh</a>
  </div><br>
</form>
  ...
  ?>
      <div class="column">
        <tr>
          ...
          <!-- <td align="center"><a href="user-update-medicine.php?id=<?php echo $row['id'];?>"  class="btn btn-info">Update</a></td> -->
        </tr>
      </div>  
  <?php
  }
