    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <a href="admin-patient-profile-edit.php?patient_id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a>&nbsp;
          <a href="admin-add-prescription.php?patient_id=<?php echo $row['id'];?>"><i class="fa fa-plus"></i></a>&nbsp;
          <a href="<?php echo 'patient-profile-print.php?patient_id='.urlencode($_GET['patient_id']).(isset($row['dadmit']) ? '&order_date='.urlencode($row['dadmit']) : ''); ?>" target="_blank"><i class="fa fa-print"></i></a>
        <hr>
<div class="column">
  <div class="name"><br>
