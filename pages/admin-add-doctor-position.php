...
$dup=mysqli_query ($con, "select * from doctorpositiontbl where position='$position'");
if(mysqli_num_rows($dup)>0){
  echo "<script>alert('The data you input is already exist.')</script>";
  echo "<script>document.location='admin-add-doctor-position.php';</script>";
}
else{

    $query = "INSERT INTO `doctorpositiontbl` (`position`)

    VALUES ('$position')";

      if($query){
        echo "<script>alert('New Position successfully saved!')</script>";
        echo "<script>document.location='admin-add-doctor-position.php';</script>";
      } else {
          echo "Failed";
       }
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title" align="center">Add New Doctor Position</div><hr><br>

          <form action="admin-add-doctor-position.php" class="form-container" method="post">
            <div class="row">
              <div class="column">
                <div class="d-flex fcol-md-3 align-items-center text-center p-3 py-5">
                  <div class="col-md-9">
                  <input class="form-control" type="text" name="position" placeholder="Doctor position" required="">
                </div>
                  <div class="col-md-2">
          ...
          <?php
            ...
            $sql = "SELECT * FROM `doctorpositiontbl`";  
